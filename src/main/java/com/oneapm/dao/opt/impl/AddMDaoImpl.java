...
public class AddMDaoImpl extends DaoImplBase<App> {
        protected static final Logger LOG = LoggerFactory.getLogger(AddMDaoImpl.class);
        protected static final String TABLE_NAME = "appM";

        static {
                Instance = new AddMDaoImpl();
        }

        private final static AddMDaoImpl Instance;

        public static AddMDaoImpl getInstance() {
                return Instance;
        }

        public List<App> findByAgent(int agent, String start, String banben, String end){
