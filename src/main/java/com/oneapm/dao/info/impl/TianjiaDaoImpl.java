...
public class TianjiaDaoImpl extends DaoImplBase<Long> {
        protected static final Logger LOG = LoggerFactory.getLogger(TianjiaDaoImpl.class);
        protected final String TABLE_NAME = "tianjia";

        static {
                Instance = new TianjiaDaoImpl();
        }

        private final static TianjiaDaoImpl Instance;

        public static TianjiaDaoImpl getInstance() {
                return Instance;
        }
