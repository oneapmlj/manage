			...
			<div style="width:100%;">
				<div style="width:400px;height:300px;margin-top:200px;margin-left:auto;margin-right:auto;">
					<div style="width:400px;font-size:14px;line-height:20px;">
						<div style="width:400px;float:left;">请输入您的邮箱：</div>
						<div style="width:200px;float:left;"><input type="text" id="password_email"/></div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$("#account_password").live('click', function(){
				...
				$.ajax({
					dataType:'json',
					url:'account_password_apply.action',
					data:{email:email}
				}).done(function(da){
					if(da.status == 1){
						alert("提交成功，请登录邮箱重置密码");
					}else{
						alert(da.msg);
					}
				});
